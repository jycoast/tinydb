...
import HtmlCellView from '/@/components/CellData/HtmlCellView.vue';
import MapCellView from '/@/components/CellData/MapCellView.vue';
import TextCellViewWrap from '/@/components/CellData/TextCellViewWrap.vue';
import TextCellViewNoWrap from '/@/components/CellData/TextCellViewNoWrap.vue';
import JsonCellView from '/@/components/CellData/JsonCellView.vue';
import JsonRowView from '/@/components/CellData/JsonRowView.vue';
import PictureCellView from '/@/components/CellData/PictureCellView.vue';
import WidgetTitle from './WidgetTitle.vue'
import {selectionCouldBeShownOnMap} from '/@/components/Elements/MapView'
